...
def get_encoding(seqs):
    ...
    for idx in tqdm(range(0,len(seqs),batch_size)):
        ...
        token_representations = results["representations"][33][:,0,:].cpu().data.numpy()
...
np.save('../../../data/bind/esm1v_train_data.npy',data_train)
np.save('../../../data/bind/esm1v_train_label.npy',label_train)
np.save('../../../data/bind/esm1v_test_data.npy',data_test)
np.save('../../../data/bind/esm1v_test_label.npy',label_test)