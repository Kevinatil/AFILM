...
data_train, label_train = embedding_batch(json_train, embed_backbone, tokenizer)
data_test, label_test = embedding_batch(json_test, embed_backbone, tokenizer)

np.save('../../../data/bind/bert_train_data.npy',data_train)
np.save('../../../data/bind/bert_train_label.npy',label_train)
np.save('../../../data/bind/bert_test_data.npy',data_test)
np.save('../../../data/bind/bert_test_label.npy',label_test)



train_data=np.load('../../../data/bind/bert_train_data.npy')
#data_train=np.max(data_train,axis=1)
data_train=train_data[:,0,:]
np.save('../../../data/bind/bert_train_data_cls.npy',data_train)

test_data=np.load('../../../data/bind/bert_test_data.npy')
#data_test=np.max(data_test,axis=1)
data_test=test_data[:,0,:]
np.save('../../../data/bind/bert_test_data_cls.npy',data_test)