...
embed_all=pickle.load(open('../../../data/paratope/embed_all_bert.pickle','rb'))
print(embed_all[list(embed_all.keys())[0]])
print(embed_all[list(embed_all.keys())[1]])

info=pd.read_csv('../../../data/paratope/info.csv')
print(info.head())
...
for i in range(k):
    ...
    np.save('../../../data/paratope/bert_train_data_{}.npy'.format(i),data_)
    np.save('../../../data/paratope/bert_train_label_{}.npy'.format(i),label_)
    np.save('../../../data/paratope/bert_train_seq_{}.npy'.format(i),tp_)
    

#tp_=test_seq
#data_,label_=get_fold_data(tp_)
#print(data_.shape,label_.shape)
#np.save('../../../data/paratope/bert_test_data.npy',data_)
#np.save('../../../data/paratope/bert_test_label.npy',label_)
#np.save('../../../data/paratope/bert_test_seq.npy',tp_)