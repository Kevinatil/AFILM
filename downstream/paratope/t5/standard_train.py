...
if __name__ == '__main__':
    ...
    for i_ in range(k):
        ...
        for j in range(k):
            if j==i_:
                val_feats=np.load('../../../data/paratope/t5_train_data_{}.npy'.format(j))
                val_cls_label=np.load('../../../data/paratope/t5_train_label_{}.npy'.format(j))
            else:
                train_feats.append(np.load('../../../data/paratope/t5_train_data_{}.npy'.format(j)))
                train_cls_label.append(np.load('../../../data/paratope/t5_train_label_{}.npy'.format(j)))
