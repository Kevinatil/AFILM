...
pd.DataFrame(data_all,columns=['sequence','cdr1','label1','cdr2','label2','cdr3','label3']).to_csv('../../../data/paratope/info.csv', 
                                                                                                   index=False)
...
with open('../../../data/paratope/embed_all_t5.pickle','wb') as f:
