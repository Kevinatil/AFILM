...
embed_all=pickle.load(open('../../../data/paratope/embed_all_t5.pickle','rb'))
...
for i in range(k):
    ...
    np.save('../../../data/paratope/t5_train_data_{}.npy'.format(i),data_)
    np.save('../../../data/paratope/t5_train_label_{}.npy'.format(i),label_)
    np.save('../../../data/paratope/t5_train_seq_{}.npy'.format(i),tp_)
