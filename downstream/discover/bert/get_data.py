...
embed_all=pickle.load(open('../../../data/discover/embed_data_bert.pickle','rb'))
print(embed_all[list(embed_all.keys())[0]])
print(embed_all[list(embed_all.keys())[1]])

info=pd.read_csv('../../../data/discover/info_bert.csv')
print(info.head())
...
for i in range(k):
    ...
    np.save('../../../data/discover/bert_all_data_{}.npy'.format(i),data_)
    np.save('../../../data/discover/bert_all_label_{}.npy'.format(i),label_)
    np.save('../../../data/discover/bert_all_subject_{}.npy'.format(i),tp_)
...
#data_,label_=get_fold_data(tp_)
#print(data_.shape,label_.shape)
#np.save('bert_test_data.npy',data_)
#np.save('bert_test_label.npy',label_)
#np.save('bert_test_subject.npy',tp_)
