...
if __name__ == '__main__':
    ...
    for i_ in range(k):
        ...
        for j in range(k):
            if j==i_:
                val_feats=np.load('../../../data/discover/bert_all_data_{}.npy'.format(j))
                val_cls_label=np.load('../../../data/discover/bert_all_label_{}.npy'.format(j))
            else:
                train_feats.append(np.load('../../../data/discover/bert_all_data_{}.npy'.format(j)))
                train_cls_label.append(np.load('../../../data/discover/bert_all_label_{}.npy'.format(j)))
        ...
        for epoch in range(EPOCH):
            ...
            for step, (feat_, cls_label_) in enumerate(train_loader_single):
                ...
                #print(cls_output.shape,cls_label_.shape)
                try:
