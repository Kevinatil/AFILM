...
pd.DataFrame(np.array([seq_all,disease_all,subject_all]).T,columns=
             ['sequence','disease','subject']).to_csv('../../../data/discover/info_bert.csv'
                                                      ,index=False)



df=pd.read_csv('../../../data/discover/info_bert.csv')
...
with open('../../../data/discover/embed_data_bert.pickle','wb') as f:
