...
embed_all=pickle.load(open('../../../data/discover/embed_data_t5.pickle','rb'))
print(embed_all[list(embed_all.keys())[0]])
print(embed_all[list(embed_all.keys())[1]])

info=pd.read_csv('../../../data/discover/info_t5.csv')
print(info.head())
...
for i in range(k):
    ...
    np.save('../../../data/discover/t5_all_data_{}.npy'.format(i),data_)
    np.save('../../../data/discover/t5_all_label_{}.npy'.format(i),label_)
    np.save('../../../data/discover/t5_all_subject_{}.npy'.format(i),tp_)
