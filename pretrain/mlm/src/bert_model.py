...
class EmbeddingPostprocessor(nn.Cell):
    ...
    def construct(self, word_embeddings, token_type_ids):
        """Postprocessors apply positional and token type embeddings to word embeddings."""
...
class BertModel(nn.Cell):
    ...
    def construct(self, input_ids, input_mask, token_type_ids):
        """Bidirectional Encoder Representations from Transformers."""
        # embedding
        embedding_tables = self.bert_embedding_lookup.embedding_table
        word_embeddings = self.bert_embedding_lookup(input_ids)
        embedding_output = self.bert_embedding_postprocessor(word_embeddings, token_type_ids)
        ...
        return sequence_output, embedding_tables
